    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Chikun Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Chikun Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Chikun Core is shutting down...") + "<br /><br />" +
