...
#if defined(NDEBUG)
# error "Chikun cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Chikun Signed Message:\n";
...
static const CAmount nStartSubsidy = 100 * COIN;
static const CAmount nMinSubsidy = 0.09765625 * COIN;
