...
bitcoind/bitcoin-cli binaries are not included in the Chikun-Qt.app bundle.

If you are building `bitcoind` or `Chikun-Qt` for others, your build machine should be set up
...
Once dependencies are compiled, see [doc/release-process.md](release-process.md) for how the Chikun-Qt.app
