...
Chikun-Qt can display and save QR codes for sending
...
versions of Chikun-Qt/bitcoind.
...
Chikun-Qt's initial splash screen
...
opening/launching Chikun-Qt is available only on Linux,
and only if you configure your desktop to launch
Chikun-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Chikun-Qt window to start
payment.
...
It is expected that future releases of Chikun-Qt
