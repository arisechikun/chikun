...
Fix Chikun-Qt notifications under Growl 1.3.
Increase required age of Chikun-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Chikun-Qt over it. (Windows)
