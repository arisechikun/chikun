...
Do not blank "label" in Chikun-Qt "Send" tab, if the user has already entered something.
...
Automatically focus and scroll to new "Send coins" entries in Chikun-Qt.
Show a message box for --help on Windows, for Chikun-Qt.
Add missing "About Qt" menu option to show built-in Qt About dialog.
Don't show "-daemon" as an option for Chikun-Qt, since it isn't available.
